...
const Body = () => {
  ...
  useEffect(() => {
    const fetchRestaurants = async () => {
      try {
        ...
        // --- THIS IS THE FIX ---
        //
        // Instead of calling Swiggy's API directly, we call our OWN
        // API proxy route (/api/swiggy). This route lives in the
        // 'api/swiggy.js' file.
        //
        // This request goes from your browser -> Vercel's server (your function)
        //
        ...
        // The rest of your logic is perfect and remains the same
        const restaurants =
  ...
  // Your component JSX is great, no changes needed here.
